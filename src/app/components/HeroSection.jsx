      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-7xl lg:leading-normal font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3AAFA9] to-[#DEF2F1] ">
              Hello, I&apos;m{" "}
            </span>
            <br />
            <TypeAnimation
          ...
          <p className="text-[#ADB7BE]  text-base sm:text-lg mb-6 lg:text-xl">
            Lorem ipsum In publishing and graphic design.
          </p>
          <div>
            <button
        ...
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5 }}
          className="col-span-4 place-self-start mt-4 lg:mt-0"
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
              src="/images/IMG_sqrppr.png"
              alt="profile pic"
